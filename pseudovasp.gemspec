...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Energy calculation using empirical potentials under VASP consistent data cards}
  spec.description   = %q{Energy calculation using empirical potentials under VASP consistent data cards}
